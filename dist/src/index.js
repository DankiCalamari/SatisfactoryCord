...
import { ApiRunCommandProvider, StdinCommandProvider, StrictConsoleMessageProvider, UnavailableCommandProvider, UnavailableMessageProvider } from "./satisfactory/commands.js";
...
async function main() {
    ...
    let commandProvider = new UnavailableCommandProvider();
    let messageProvider = new UnavailableMessageProvider();
...
async function handleWrapperCommand(line, processManager, api, commandProvider, capabilities, logger) {
...
function startupBanner(executable, workingDirectory) {
    return [
        "=======================================================",
        "                  SatisfactoryCord",
        "=======================================================",
